...
require_once('../../controllers/UpdateCatController.php');
            ...
            <div class="card">
                <div class="card-body">
                    <form class="text-center" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group mt-3">
                            <img src="../../assets/images/<?php echo $cat_image ?>" alt="cat_image" width="70%">
                            <br><br>
                        ...
                        <div class="form-group mt-3">
                            ...
                            <input class="form-control text-muted" name="cat_name" type="text" id="name" value="<?php echo $cat_name ?>">
                        </div>
                        <div class="form-group mt-3">
                            <label for="formFile" class="form-label">Sex</label>
                            <input class="form-control text-muted" name="cat_sex" type="text" text id="sex" value="<?php echo $cat_sex ?>">
                        </div>
                        <div class="form-group mt-3">
                            <label for="formFile" class="form-label">Age</label>
                            <input class="form-control" name="cat_age" type="text" id="age" value="<?php echo $cat_age ?>">
                        </div>
                        <div class="form-group mt-3">
                            <label for="formFile" class="form-label">Category</label>
                            <input class="form-control" type="text" name="cat_category" id="age" value="<?php echo $cat_category ?>">
                        </div>
                        <div class="form-group mt-3">
                            <label for="exampleFormControlTextarea1" class="form-label">Description</label>
                            <textarea class="form-control" name="cat_description" id="exampleFormControlTextarea1" rows="3"><?php echo $cat_description ?></textarea>
                        </div>
